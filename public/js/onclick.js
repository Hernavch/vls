$(document).ready(function() {
  ...
  var jobSeekerCounter = 0;
  var employerCounter = 0;
  var recruiterCounter = 0;
  ...
  $("#new-seekers-button").on("click", function() {
    ...
    <div class="group">
      <div class="card-body">
        ...
        <select name="experience" class="chosen-select" id="q2">
          <option value=""></option>
  ...
  `)
    // alert("Please sign-up and complete our new user survey.");
    jobSeekerCounter++;

  });


  $("#new-employers-button").on("click", function() {
    $('#form-container').html(`
    <form id="new-employer-form" name="new-employer-form">
              ...
              <div class="input-group card-body">
                <label for="company_name">
                  Company name
                  <sup class="required" title="Required">*</sup>
                </label>    <input type="text" name="company" id="company_name" class="required" autocapitalize="off" autofocus="autofocus" placeholder="Company name">
              </div>
              ...
              <div class="group" id="job-type">
                <div class="card-body">
                  ...
                  <fieldset>
                    ...
                    <div>
                      <input type="checkbox" id="DSP2" name="cert_DSP2" value=true>
                      <label for="DSP2">Direct Support Professional 2 | DSP-2</label>
                    </div>
                    <div>
              ...
              //     <p>4. Please list any other healthcare certificates that you seek from a candidate.</p>
              //     <input type="text" name="position" id="job-type" class="form-control" required>
              //   </div>   
              // </div>  
              <div class="card-body">   
                <label for="email">Email</label>
...
`)
  ...
  $("#new-recruiters-button").on("click", function() {
$("#form-container").html(`
<form id="new-recruiter-form" name="new-recruiter-form">
                <h3>NEW RECRUITER </h3><h5>signup form</h5>
              </div>
              <div class="input-group card-body">
                <label for="first_name">
                  First name
              ...
              <div class="group" id="job-type">
                <div class="card-body">
                  ...
                  <fieldset>
                      <legend></legend>
                      <div>
                        <input type="checkbox" id="FT" name="position" value="FT">
                        <label for="FT">Full-Time</label>
                      </div>
                      <div>
                        <input type="checkbox" id="PT" name="position" value="PT">
                        <label for="PT">Part-Time</label>
                      </div>
                      <div>
...
$("#new-candidate-form").on("submit" ,function(event){
  ...
  $.post("/api/new-candidate", paramObj,function(res){
    console.log(res);
    if(res === res.success){
